					...
					<input type="hidden" id="outcome"><xsl:attribute name="value"><xsl:value-of select="/category/@name" />, <xsl:value-of select="//*[@id = $focus]/@result" /></xsl:attribute></input>
                      ...
                      <xsl:value-of select="//*[@id = $focus]/word" disable-output-escaping="yes"/>
                        ...
                        <xsl:if test="//*[@id = $focus]/@postcode != ''">
                                ...
                                <xsl:when test="//*[@id = $focus]/@law-society != ''"> <!-- Law Society provider search -->
                                    ...
                                    <form method="post" class="find-location-for-service" action="http://www.lawsociety.org.uk/find-a-solicitor/">
                                        <fieldset>
                                            ...
                                            <label for="postcode">
                                                Enter a UK postcode
                                                <input class="postcode" id="postcode" name="POSTCODE" type="text" placeholder="e.g. W12 0LL" />
                                ...
                                <xsl:otherwise> <!-- Internal provider search -->
                                    ...
                                    <form action="http://find-legal-advice.justice.gov.uk/search.php" method="get" id="local-locator-form" class="find-location-for-service">
                                        ...
                                        <fieldset>
                                            ...
                                            <label for="postcode">
                                                Enter a UK postcode
                                                <input class="postcode" id="postcode" name="searchtext" type="text" placeholder="e.g. W12 0LL" />
                                            </label>
                            ...
                            <div id="more" style="display:none;"><a href="#">More results &gt;</a></div>
...
<!-- INDEX AND START TEMPLATES - These are never generated automatically -->
    ...
    <xsl:template name="head">
        ...
        <xsl:text disable-output-escaping="yes">&lt;!--&lt;![endif]--&gt;</xsl:text><head>
            ...
            <xsl:text disable-output-escaping="yes">&lt;!--[if gt IE 8]&gt;&lt;!--&gt;</xsl:text>
            <link href="https://assets.digital.cabinet-office.gov.uk/static/application-07bda3fe4e56a5e03e7b7cbed3d1eca6.css" media="screen" rel="stylesheet" type="text/css" />
            <xsl:text disable-output-escaping="yes">&lt;!--&lt;![endif]--&gt;</xsl:text>

            <xsl:text disable-output-escaping="yes">&lt;!--[if IE 6]&gt;</xsl:text>
            <link href="https://assets.digital.cabinet-office.gov.uk/static/application-ie6-79313a17813b4c0709b46326dd8084bc.css" media="screen" rel="stylesheet" type="text/css" />
            <xsl:text disable-output-escaping="yes">&lt;![endif]--&gt;</xsl:text>

            <xsl:text disable-output-escaping="yes">&lt;!--[if IE 7]&gt;</xsl:text>
            <link href="https://assets.digital.cabinet-office.gov.uk/static/application-ie7-dec122a14a37397d46f9ed45e420e7d6.css" media="screen" rel="stylesheet" type="text/css" />
            <xsl:text disable-output-escaping="yes">&lt;![endif]--&gt;</xsl:text>
 
            <xsl:text disable-output-escaping="yes">&lt;!--[if IE 8]&gt;</xsl:text>
            <link href="https://assets.digital.cabinet-office.gov.uk/static/application-ie8-428b9a9b358acee1fdf011f667514c2e.css" media="screen" rel="stylesheet" type="text/css" />
            <xsl:text disable-output-escaping="yes">&lt;![endif]--&gt;</xsl:text>

            <link href="https://assets.digital.cabinet-office.gov.uk/static/print-9e9ee3f9c14247af1d926867d66e5bed.css" media="print" rel="stylesheet" type="text/css" />

            <script src="https://assets.digital.cabinet-office.gov.uk/static/libs/jquery/jquery-1.7.2-765cc76e15d62a88cd61468aeaaaeb5d.js" type="text/javascript"></script>

            <xsl:text disable-output-escaping="yes">&lt;script defer src="https://assets.digital.cabinet-office.gov.uk/static/application-9ade210344d307096d0e4c678c0b5428.js" type="text/javascript"&gt;&lt;/script&gt;</xsl:text>
            ...
            <link rel="shortcut icon" href="https://assets.digital.cabinet-office.gov.uk/static/favicon.ico" type="image/x-icon" />
            <xsl:comment> For third-generation iPad with high-resolution Retina display: </xsl:comment>
	        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="https://assets.digital.cabinet-office.gov.uk/static/apple-touch-icon-144x144-eee4e09bccd7c55b9b8dca2d6715ffa4.png" />
            <xsl:comment> For iPhone with high-resolution Retina display: </xsl:comment>
            <link rel="apple-touch-icon-precomposed" sizes="114x114" href="https://assets.digital.cabinet-office.gov.uk/static/apple-touch-icon-114x114-460f91576fe9c617d4fdf7df46cfaef5.png" />
            <xsl:comment> For first- and second-generation iPad: </xsl:comment>
            <link rel="apple-touch-icon-precomposed" sizes="72x72" href="https://assets.digital.cabinet-office.gov.uk/static/apple-touch-icon-72x72-52dfb66accadbd018bd25b13ed7fac68.png" />
            <xsl:comment> For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: </xsl:comment>
            <link rel="apple-touch-icon-precomposed" href="https://assets.digital.cabinet-office.gov.uk/static/apple-touch-icon-57x57-7ed7919994fcf4a885cb56cc30fbed42.png" />
    ...
    <xsl:template name="header">
       <header class="page-header group" id="global-header"><h1>
<div class="header-wrapper group"> <a href="#footer" class="visuallyhidden">Skip to footer navigation</a> 
  <span class="organisation-logo organisation-logo-stacked-single-identity organisation-logo-stacked-single-identity-large">
        <span>Ministry<br />of Justice</span>
      </span>
  </div>
</h1></header>
    </xsl:template>
            ...
            <div class="footer-wrapper">
                ...
                <div class="footer-meta">
                    <div class="footer-meta-inner">
                        ...
                        <ul>
                            <li>
                                <a href="#">Legal Aid Agency</a>
                            </li>
                            <li>
                                <a href="http://www.justice.gov.uk/">Justice</a>
                            </li>
                            <li>
